...
public final class CallTargetGrpc {
  ...
  public static io.grpc.MethodDescriptor<Message.CallTargetPayload, Message.CallTargetResponse> getCallTargetMethod() {
    ...
    if ((getCallTargetMethod = CallTargetGrpc.getCallTargetMethod) == null) {
      synchronized (CallTargetGrpc.class) {
        if (
          (getCallTargetMethod = CallTargetGrpc.getCallTargetMethod) == null
        ) {
          CallTargetGrpc.getCallTargetMethod =
            getCallTargetMethod =
              io.grpc.MethodDescriptor
                ...
                .setFullMethodName(
                  generateFullMethodName(SERVICE_NAME, "callTarget")
                )
                ...
                .setSchemaDescriptor(
                  new CallTargetMethodDescriptorSupplier("callTarget")
                )
                .build();
        }
      }
   ...
   */
  public static CallTargetBlockingStub newBlockingStub(
  ...
  /**
   */
  public abstract static class CallTargetImplBase
  ...
  /**
   */
  public static final class CallTargetStub
    extends io.grpc.stub.AbstractStub<CallTargetStub> {

    private CallTargetStub(io.grpc.Channel channel) {
      super(channel);
    }

    private CallTargetStub(
      io.grpc.Channel channel,
    ...
    @java.lang.Override
    protected CallTargetStub build(
      io.grpc.Channel channel,
      io.grpc.CallOptions callOptions
    ) {
    ...
    public void callTarget(
      ...
      asyncUnaryCall(
        getChannel().newCall(getCallTargetMethod(), getCallOptions()),
        request,
        responseObserver
      );
    }
  ...
  /**
   */
  public static final class CallTargetBlockingStub
    extends io.grpc.stub.AbstractStub<CallTargetBlockingStub> {

    private CallTargetBlockingStub(io.grpc.Channel channel) {
      super(channel);
    }

    private CallTargetBlockingStub(
      io.grpc.Channel channel,
      io.grpc.CallOptions callOptions
    ) {
      super(channel, callOptions);
    ...
    @java.lang.Override
    protected CallTargetBlockingStub build(
      io.grpc.Channel channel,
      io.grpc.CallOptions callOptions
    ) {
    ...
    /**
     */
    public Message.CallTargetResponse callTarget(
      Message.CallTargetPayload request
    ) {
  ...
  /**
   */
  public static final class CallTargetFutureStub
    extends io.grpc.stub.AbstractStub<CallTargetFutureStub> {

    private CallTargetFutureStub(io.grpc.Channel channel) {
      super(channel);
    }

    private CallTargetFutureStub(
      io.grpc.Channel channel,
      io.grpc.CallOptions callOptions
    ) {
      super(channel, callOptions);
    ...
    @java.lang.Override
    protected CallTargetFutureStub build(
      io.grpc.Channel channel,
      io.grpc.CallOptions callOptions
    ) {
  ...
  private static final class CallTargetFileDescriptorSupplier
