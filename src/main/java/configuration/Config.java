...
public class Config {
    ...
    public static String USE_CORRELATION_ID;
    public static String CORRELATION_HEADER_KEY;
    ...
    public static void init() throws Exception {
        ...
        USE_CORRELATION_ID = getOptionalBool(dotenv, "USE_CORRELATION_ID", false);
        CORRELATION_HEADER_KEY = getOptionalString(dotenv, "CORRELATION_HEADER_KEY", "x-correlation-id");
